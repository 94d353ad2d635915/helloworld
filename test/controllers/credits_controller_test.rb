...
class CreditsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create credit" do
    assert_difference('Credit.count') do
      post credits_url, params: { credit: { balance: @credit.balance, currency: @credit.currency, user_id: @credit.user_id } }
    end
  ...
  test "should update credit" do
    patch credit_url(@credit), params: { credit: { balance: @credit.balance, currency: @credit.currency, user_id: @credit.user_id } }
